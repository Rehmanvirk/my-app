...
//    }
    ...
    Column(
        ...
        TopBarWithBack(title = "Tasks",onCreateLeade = {
...
//        )
        ...
        LazyColumn(
            ...
            if (state.isLoading) {
                ...
                items(state.allTasks) { lead ->
                    TaskCard(lead = lead, onClick = {
                        val idToPass = lead.id
                        navController.navigate("EditTaskScreen/$idToPass") {
                            popUpTo("EditTaskScreen"){
                                this.inclusive = true
                            }
                        }
                        /* open lead details */ })
...
@Composable
private fun TaskCard(lead: Tasks, onClick: () -> Unit) {
    Surface(
        onClick = onClick,
